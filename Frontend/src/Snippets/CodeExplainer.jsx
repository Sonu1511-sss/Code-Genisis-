...
const CodeExplainer = () => {
  ...
  const FetchChart = async () => {
    ...
    try {
      ...
      const res = await axios.post(" https://code-genisis-back-2.onrender.com/ai/get-response" , 
  ...
  const AddToFavourite = async () => {
    try {
      const res = await axios.post(" https://code-genisis-back-2.onrender.com/user/addfavourite" , {code : code , response : response} , {withCredentials : true}) ; 
